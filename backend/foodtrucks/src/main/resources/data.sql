...
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30001,'Buzz''s Hawaiian Grill','1234 Main Street','St. Louis, MO 63104','1-31-20','11:00am','2:00pm','20001','https://i.imgur.com/FVi7ikp.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30002,'Cheese Shack Food Truck','32 Jefferson Ave','St. Louis, MO 63104','1-31-20','12:00pm','3:00pm','20002','https://i.imgur.com/isJ3USj.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30003,'Destination  Desserts','245 S. Central Ave','Clayton, MO 63105','1-31-20','12:00pm','3:30pm','20003','https://i.imgur.com/DBUUTsg.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30004,'Essentially Fries','1 Industrial Circle','Chesterfield, MO 63345','2-1-20','1:00pm','4:00pm','20004','https://i.imgur.com/pMMcldr.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30005,'Go! Gyro! Go!','245 S. Central Ave','Clayton, MO 63105','2-1-20','2:00pm','5:00pm','20005','https://i.imgur.com/cpKFZ9J.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30006,'Guerilla Street Food','1234 Main Street','St. Louis, MO 63104','1-31-20','5:00pm','7:30pm','20006','https://i.imgur.com/Lc1sI9Q.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30007,'K-bop','1234 Main Street','St. Louis, MO 63104','2-1-20','8:00pm','11:00pm','20007','https://i.imgur.com/8n3WUR7.png');
insert into event(id, truck_name, event_address, event_city, event_date, start_time, end_time, truck_id, img_url) values(30008,'Joe''s Pizza','1234 Main Street','St. Louis, MO 63104','2-1-20','8:00pm','11:00pm','20001','https://i.imgur.com/FVi7ikp.png'); 
